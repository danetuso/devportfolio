...
if ( basename(__FILE__) == basename($_SERVER["SCRIPT_FILENAME"]) ) { 
    ...
    return [
        0 => [
            'name' => 'AA Tutoring Site',
            'description' => 'Accurate Academic Tutoring with Mr. Martin in Huntington Beach, California',
            'http' => 'https://aatutoring.net',
            'image' => 'images/aatutoring.png',
        ],
        1 => [
        ...
        4 => [
            ...
            'description' => "I worked with a privately owned Mercedes Benz MotorWerks dealership in Illinois. This project makes the workflow for Service and Purchase Request Forms more efficient by adding a searchable database, showing all active submitted forms, and allowing managers to waive pricing with an electronic signature.",
            'http' => '#',
